        ...
        private void processBroadcast(String socketMsg) {
            ...
            switch (map.getString("_method_")) {
                ...
                case Constants.SOCKET_SEND_GIFT://送礼物
                    ...
                    if (receiveGiftBean.getType() == 3) {//手绘礼物
        ...
        private void processLinkMicAnchor(JSONObject map) {
            ...
            switch (action) {
                ...
                case 4://所有人收到对方主播的播流地址的回调
                    mListener.onLinkMicAnchorPlayUrl(map.getString("pkuid"), map.getString("tostream"), map.getString("pkpull"));
                    break;
                case 5://断开连麦的回调
        ...
        private void processVoiceRoom(JSONObject map) {
            ...
            switch (action) {
                ...
                case 2://观众收到主播同意或拒绝上麦的消息
                    mListener.onVoiceRoomHandleApply(map.getString("touid"), map.getString("toname"), map.getString("avatar"), map.getIntValue("position"));
                    break;
                case 3://所有人收到某人下麦的消息
