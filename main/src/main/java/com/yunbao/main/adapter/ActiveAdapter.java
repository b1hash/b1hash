...
public class ActiveAdapter extends RefreshAdapter<ActiveBean> {
    ...
    private void init(Context context) {
        ...
        mStringYong = WordUtil.getString(R.string.a_081);
        ...
        mGoodsClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String shareUid = (String) v.getTag(R.string.a_003);
...
//                mCity.setText(StringUtil.contact(bean.getCity(), " | ", bean.getDateTime()));
                mCity.setText(StringUtil.contact(bean.getDateTime()));
                if (bean.isSelf()) {
            ...
            if (payload == null) {
                ...
                if (!TextUtils.isEmpty(goodsInfoJson) && !"{}".equals(goodsInfoJson)) {
                    try {
                        ...
                        mBtnGoods.setTag(R.string.a_001, goodsInfo.getString("id"));
                        mBtnGoods.setTag(R.string.a_002, goodsInfo.getString("type"));
                        mBtnGoods.setTag(R.string.a_003, bean.getUid());
