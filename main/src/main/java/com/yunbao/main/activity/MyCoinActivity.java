...
//                            String money = StringUtil.contact(isPayPal ? "$" : "￥", coinBean.getMoney());
                            mBtnCharge.setText(String.format(WordUtil.getString(R.string.chat_charge_tip), coinBean.getMoney()));
                        }
                    }
                }
                mIsPayPal = isPayPal;
...
//                            String money = StringUtil.contact(mIsPayPal ? "$" : "￥", coinBean.getMoney());
    ...
    private void charge() {
        ...
        CommonHttpUtil.getPayUrl(bean.getMoney(),bean.getId(), bean.getCoin(), coinPayBean.getPaytype(), new HttpCallback() {
...
//        }
    ...
    protected void onDestroy() {
        ...
        CommonHttpUtil.cancel(CommonHttpConsts.GET_PAY_TYPE);
        if (mRefreshLayout != null) {
