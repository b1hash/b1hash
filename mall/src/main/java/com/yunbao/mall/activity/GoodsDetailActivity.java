...
import com.yunbao.mall.dialog.GoodsShareDialogFragment;
...
public class GoodsDetailActivity extends AbsActivity implements View.OnClickListener {
    ...
    private void shareGoods() {
        ...
        bundle.putString(Constants.TIP, StringUtil.contact(WordUtil.getString(R.string.money_symbol), mShareIncome));
